        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-5 pt-4 border-t border-slate-100 text-xs">
          ...
          <div>
            ...
            <span className="font-semibold text-slate-800">
              {project.targetGoLive ? format(new Date(project.targetGoLive), "dd/MM/yyyy") : "TBD"}
            </span>
          </div>
          <div>
                ...
                {actionItems.map((item: any) => (
                  <tr key={item.id} className="hover:bg-slate-50/80 transition">
                    ...
                    <td className="py-3 px-3 text-slate-600">
                      {item.targetDate ? format(new Date(item.targetDate), "dd/MM/yyyy") : "-"}
                    </td>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    <div className="text-[11px] font-bold text-blue-600 mb-1">
                      {format(new Date(mom.meetingDate), "dd/MM/yyyy")}
                    </div>
                ...
                <div className="flex items-center justify-between pb-3 border-b border-slate-100">
                  <div className="flex items-center gap-3">
                    <div className="text-xs font-bold text-slate-900">
                      {format(new Date(dar.reportDate), "dd/MM/yyyy (EEEE)")}
                    </div>
